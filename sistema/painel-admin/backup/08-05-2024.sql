...
INSERT INTO `alunos` (`id`, `nome`, `cpf`, `email`, `telefone`, `endereco`, `cidade`, `estado`, `pais`, `foto`, `data`, `cartao`, `ativo`) VALUES ('40', 'JOSÉ MARIO SANTOS CONCEIÇÃO', '062.114.855-57', 'santosjosemario449@gmail.com', '', '', '', '', '', 'sem-perfil.jpg', '2024-05-07', '', 'Sim');
...
INSERT INTO `matriculas` (`id`, `id_curso`, `aluno`, `professor`, `aulas_concluidas`, `valor`, `data`, `status`, `pacote`, `alertado`, `valor_cupom`, `subtotal`, `forma_pgto`, `boleto`, `id_pacote`, `data_conclusao`, `total_recebido`, `obs`, `nota`, `ref_api`) VALUES ('38', '54', '44', '', '1', '0.00', '2024-05-07', 'Matriculado', '', '', '0.00', '0.00', '', '', '0', '', '0.00', '', '', '');
INSERT INTO `matriculas` (`id`, `id_curso`, `aluno`, `professor`, `aulas_concluidas`, `valor`, `data`, `status`, `pacote`, `alertado`, `valor_cupom`, `subtotal`, `forma_pgto`, `boleto`, `id_pacote`, `data_conclusao`, `total_recebido`, `obs`, `nota`, `ref_api`) VALUES ('39', '52', '44', '', '1', '0.00', '2024-05-07', 'Matriculado', '', '', '0.00', '0.00', '', '', '0', '', '0.00', '', '', '');
...
INSERT INTO `matriculas` (`id`, `id_curso`, `aluno`, `professor`, `aulas_concluidas`, `valor`, `data`, `status`, `pacote`, `alertado`, `valor_cupom`, `subtotal`, `forma_pgto`, `boleto`, `id_pacote`, `data_conclusao`, `total_recebido`, `obs`, `nota`, `ref_api`) VALUES ('43', '56', '45', '', '1', '0.00', '2024-05-07', 'Matriculado', '', '', '0.00', '0.00', '', '', '0', '', '0.00', '', '', '');
