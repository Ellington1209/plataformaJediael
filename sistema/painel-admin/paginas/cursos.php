...
<div class="modal fade" id="modalMostrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="tituloModal"><b id="nome_mostrar"> </b> - Status : <span id="status_mostrar"> </span> - Comissão: <span id="comissao_mostrar"> </span>%</h4>
				...
				<div class="row">
					<div class="col-md-6">
						<form id="form-aulas">
							...
							<small><small>
									<div id="mensagem_aulas" align="center" class="mt-3 col-md-12"></div>
								</small></small>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<br>
				<small><small>
						<div id="mensagem_sessao" align="center" class="mt-3 col-md-12"></div>
					</small></small>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<br>
				<small><small>
						<div id="mensagem_quest" align="center" class="mt-3 col-md-12"></div>
					</small></small>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<br>
				<small><small>
						<div id="mensagem_alt" align="center" class="mt-3 col-md-12"></div>
					</small></small>
