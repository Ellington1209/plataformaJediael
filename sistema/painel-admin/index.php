...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<nav class="navbar navbar-inverse" style="overflow: scroll; height:100%; scrollbar-width: thin; -ms-overflow-style: none; scrollbar-color: transparent transparent;">          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.php"><span class="fa fa-book"></span> A&S</a></h1>
          </div>
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="index.php?pagina=matricular_aluno"><i class="fa fa-angle-right"></i> Matricular Aluno</a></li>
               ...
               <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="index.php?pagina=cursos"><i class="fa fa-angle-right"></i> Cursos</a></li>
				   ...
				   <li class="<?php echo $ocultar ?>"><a href="index.php?pagina=lista_notas_alunos"><i class="fa fa-angle-right"></i> Liberar Provas alunos</a></li>
                </ul>
              </li>
