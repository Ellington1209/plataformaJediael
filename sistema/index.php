...
<head>
	...
	<meta name="description" content="Portal de Cursos Profissionalizantes A&S Assessoria e Consultoria em Segurança do Trabalho, Participe das nossas formações e seja um profissional reconhecido!!">
	<meta name="author" content="Ellington Machado">
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<a href="<?php echo $link_banner ?>" target="_blank" title="Ir para <?php echo $nome_banner ?>">
											<img src="painel-admin/img/login/<?php echo $foto_banner ?>" height="" width="80%">
										</a>
